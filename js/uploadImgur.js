function previewFile() {
    ...
    var file = document.querySelector('.page-current input[type=file]#img-file').files[0];
...
function uploadToImgur(el, callback)
{
    ...
    var settings = {
        ...
        "method": "POST",
        "headers": {
            "authorization": "Bearer 17adc0e213dd63da8e99dcf806fcead0e3466df9",
        },
        "processData": false,
        "contentType": false,
...
function ChangeUserIcon(){
    ...
    uploadToImgur(document.querySelector('[data-page="user-info"] #upload-user-icon'), function(responseData){
